...
import { I18nProvider } from "@/lib/eventra/i18n";
import { TopNav } from "@/components/eventra/top-nav";
import { BottomNav } from "@/components/eventra/bottom-nav";
import { Chatbot } from "@/components/eventra/chatbot";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-xl bg-coral px-4 py-2 text-sm font-bold text-canvas transition-colors hover:opacity-90"
          >
            Go home
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-xl border-2 border-ink bg-canvas px-4 py-2 text-sm font-bold text-ink transition-colors hover:bg-ink/5"
          >
            Go home
          </a>
        </div>
